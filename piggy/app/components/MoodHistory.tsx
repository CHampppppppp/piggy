    ...
    <div className="w-full px-2">
      ...
      <div className="space-y-3">
        {moods.length === 0 ? (
          ...
          moods.map((mood) => (
            <div key={mood.id} className="bg-gradient-to-br from-white via-pink-50/20 to-purple-50/20 p-4 rounded-2xl shadow-md border border-pink-200/50 flex gap-4 items-center transform transition-all hover:scale-[1.02] hover:shadow-lg active:scale-[0.98]">
